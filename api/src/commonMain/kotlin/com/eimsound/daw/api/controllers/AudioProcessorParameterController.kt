...
class AudioProcessorParameterController(
    parameter: IAudioProcessorParameter? = null,
    audioProcessor: UUID? = null
) : ParameterController {
    override lateinit var parameter: IAudioProcessorParameter
    ...
    override fun fromJson(json: JsonElement) {
        ...
        val pa = p.parameters.firstOrNull { it.id == parameterId }
        if (pa == null) {
