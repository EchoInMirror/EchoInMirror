...
val PencilMinus: ImageVector
    get() {
        if (pencilMinus != null) return pencilMinus!!
        pencilMinus = materialIcon(name = "EIM.PencilMinus") {
            materialPath {
...
private var pencilMinus: ImageVector? = null